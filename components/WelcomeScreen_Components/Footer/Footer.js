        ...
        <footer className="text-gray-600 body-font">
            <div
                ...
                <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                    <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                        ...
                        <span className="ml-3 text-xl">Brainlyemails</span>
                    </a>
                    <p className="mt-2 text-sm text-gray-500">Start Your Free Trial Today! It's today or never ever!</p>
                </div>
            ...
            <div className="bg-gray-100">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-gray-500 text-sm text-center sm:text-left">© 2021 Brainlyemails —
                        <a href="https://twitter.com/rookas" rel="noopener noreferrer" className="text-gray-600 ml-1"
                           target="_blank">@rookas</a>
                    </p>
