                ...
                <div className="bg-white overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg" ref={searchContent}>
                    ...
                    <form className="border-b border-gray-200">
                        <div className="relative">
                            ...
                            <input id="modal-search" className="w-full border-0 focus:ring-transparent placeholder-gray-400 appearance-none py-3 pl-10 pr-4 outline-none" type="search" placeholder="Search Anything…" ref={searchInput} />
