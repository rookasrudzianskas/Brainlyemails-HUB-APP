...
function UserMenu() {
    ...
    return (
        <div className="relative inline-flex">
            ...
            >
                <img className="w-8 h-8 rounded-full" src={'https://pbs.twimg.com/profile_images/1350895249678348292/RS1Aa0iK_400x400.jpg'} width="32" height="32" alt="User" />
                <div className="flex items-center truncate">
                    <span className="truncate ml-2 text-sm font-medium group-hover:text-gray-800">Brainlyemails Inc.</span>
            ...
            >
                ...
                >
                    <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200">
                        <div className="font-medium text-gray-800">Brainlyemails Inc.</div>
